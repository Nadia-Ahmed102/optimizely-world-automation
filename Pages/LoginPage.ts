...
export class LoginPage extends basePage {
  ...
  constructor(page: Page) {
    ...
    this.optiIDPasswordField = page.locator(
      loginPageVariables.optiIDPasswordField
    );
    this.optiIDKeepSignedInCheckbox = page.locator(
      loginPageVariables.optiIDKeepSignedInCheckbox
    );
    this.optiIDNextButton = page.locator(loginPageVariables.optiIDNextButton);
    this.optiIDVerifyButton = page.locator(
      loginPageVariables.optiIDVerifyButton
    );
    this.optiIDErrorMessage = page.getByText(
      loginPageVariables.optiIDErrorMessage
    );
    this.optiIDResetPasswordButton = page.locator(
      loginPageVariables.optiIDResetPasswordButton
    );
    this.optiIDResetPasswordMessage = page.getByText(
      loginPageVariables.optiIDResetPasswordMessage
    );

    this.worldAccLoginButton = page.locator(
      loginPageVariables.worldAccLoginButton
    );
    this.worldAccUsernameField = page.locator(
      loginPageVariables.worldAccUsernameField
    );
    this.worldAccPasswordField = page.locator(
      loginPageVariables.worldAccPasswordField
    );
    this.worldAccRememberMeCheckbox = page.getByText(
      loginPageVariables.worldAccRememberMeCheckbox
    );
    this.worldAccSignInButton = page.locator(
      loginPageVariables.worldAccSignInButton
    );
    this.worldAccWrongCredsMessage = page.getByText(
      loginPageVariables.worldAccWrongCredsMessage
    );
    this.worldAccOptiEmpLoginButton = page.locator(
      loginPageVariables.worldAccOptiEmpLoginButton
    );
    this.worldAccForgotPasswordLink = page.locator(
      loginPageVariables.worldAccForgotPasswordLink
    );
    this.worldAccSignUpButton = page.locator(
      loginPageVariables.worldAccSignUpButton
    );
