...
export class ProductMigrationPage extends basePage {
  ...
  constructor(page: Page) {
    ...
    this.accordionItem1 = page.locator(
      "#heading-accordion-264160-1 > div > div.title"
    );
    this.accordionItem2 = page.locator(
      "#heading-accordion-264160-2 > div > div.title"
    );
    this.accordionItem3 = page.locator(
      "#heading-accordion-264160-3 > div > div.title"
    );
    this.accordionItem4 = page.locator(
      "#heading-accordion-264160-4 > div > div.title"
    );
    this.accordionItem5 = page.locator(
      "#heading-accordion-264166-1 > div > div.title"
    );
    this.accordionItem6 = page.locator(
      "#heading-accordion-264166-2 > div > div.title"
    );
    this.accordionItem7 = page.locator(
      "#heading-accordion-264166-3 > div > div.title"
    );
    this.accordionItem8 = page.locator(
      "#heading-accordion-264166-4 > div > div.title"
    );
  }
  ...
  async navToProductMigrationPage(): Promise<void> {
    ...
    await this.page
      .getByRole("link", { name: "Product migration" })
  ...
  async getAllHeadings(): Promise<string[]> {
    ...
    const trimmedHeadings = headings
      .map((heading) => heading.trim())
      .filter((heading) => heading.length > 0); //trim spaces and remove empty strings
