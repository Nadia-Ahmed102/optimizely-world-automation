...
test('Verify if the user can navigate to the World Account login page', async ({ loginPage }) => {
...
test('Verify user can log in with World Account', async ({ loginPage }) => {
    ...
    await loginPage.provideInputInField(loginPage.worldAccUsernameField, loginVar.worldAccEmailValue);

    // Provide input in the password field
    await loginPage.provideInputInField(loginPage.worldAccPasswordField, loginVar.worldAccPasswordValue);
...
test('Verify user can not log in with World Account and "Forgot password?" behavior', async ({ loginPage }) => {
    ...
    // Provide input in the username field
    await loginPage.provideInputInField(loginPage.worldAccUsernameField, loginVar.worldAccWrongUsernameValue);
...
test('Verify user can navigate to Oplimizely Employee login page from World Account login page', async ({ loginPage }) => {
    // Click on the World Account login button
    await loginPage.clickButton(loginPage.worldAccLoginButton);
...
test('Verify user can sign up from World Account login page', async ({ loginPage }) => {
    // Click on the World Account login button
    await loginPage.clickButton(loginPage.worldAccLoginButton);
